"""
Django settings for MentorM project.
...
SECRET_KEY = 'django-insecure-2dhzfw$i(npby71c9cd-21f#zw+evyj!di82$5bsi^wn%z2l@9'
...
WSGI_APPLICATION = 'MentorM.wsgi.application'
